...
#
#   Este programa exibe polígonos em OpenGL e permite movelos enquanto rotacionam
#
...
def display():
    ...
    for sqr in squares:
        ...
        square(sqr.x, sqr.y, sqr.w, sqr.h, sqr.r)
...
def animate():
    ...
    if AccumDeltaT > 1.0/30:  # fixa a atualizaÃ§Ã£o da tela em 30
        ...
        if nSquare >= 0 and nSquare < len(squares):
            squares[nSquare].r = (squares[nSquare].r + 1) % 360
